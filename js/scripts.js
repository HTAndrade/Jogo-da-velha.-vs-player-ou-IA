...
// adicionando o evento de click aos boxes para
for(let i = 0; i < boxes.length; i++) {

    // quando alguem clica na caixa el
...
// limpa o jogo, declara o vencedor e atualiza o placar o
...
function computerPlay(){
    ...
    for(let i = 0; i < boxes.length; i++) {
        ...
        // só preencher se o child estiver vazio
        if(boxes[i].childNodes[0] == undefined) {
            if(randomNumber <= 1) {
